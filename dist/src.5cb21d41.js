...
},{}],"vflL":[function(require,module,exports) {
/**
...
},{}],"6nJ+":[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{}],"EDou":[function(require,module,exports) {
"use strict";
...
},{"object-assign":"YOw+","fbjs/lib/invariant":"vflL","fbjs/lib/emptyObject":"6nJ+","fbjs/lib/emptyFunction":"EDou"}],"HdMw":[function(require,module,exports) {
'use strict';
...
},{"./cjs/react.production.min.js":"pyFg"}],"gJCj":[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{}],"6gJZ":[function(require,module,exports) {
'use strict';
...
},{}],"L+D5":[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./isTextNode":"l4PP"}],"jF7N":[function(require,module,exports) {
/** @license React v16.4.1
...
},{"fbjs/lib/invariant":"vflL","react":"HdMw","fbjs/lib/ExecutionEnvironment":"gJCj","object-assign":"YOw+","fbjs/lib/emptyFunction":"EDou","fbjs/lib/getActiveElement":"6gJZ","fbjs/lib/shallowEqual":"L+D5","fbjs/lib/containsNode":"HTsx","fbjs/lib/emptyObject":"6nJ+"}],"X9zx":[function(require,module,exports) {
'use strict';
...
},{"./cjs/react-dom.production.min.js":"jF7N"}],"gYPR":[function(require,module,exports) {

},{}],"tCBH":[function(require,module,exports) {
"use strict";
...
require("./Commandline.css");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var Commandline = function Commandline(_ref) {
  var active = _ref.active,
      highlightStart = _ref.highlightStart,
      highlightEnd = _ref.highlightEnd,
      text = _ref.text,
      prefix = _ref.prefix;

  var renderedText = text;
  if (active) {
    var highlightedText = text.substr(highlightStart, highlightEnd - highlightStart);
    var highlight = _react2.default.createElement(
      "span",
      { className: "Commandline__highlight" },
      "\xA0",
      highlightedText
    );
    renderedText = _react2.default.createElement(
      "span",
      null,
...
},{"react":"HdMw","./Commandline.css":"gYPR"}],"HRuH":[function(require,module,exports) {
"use strict";
...
var Terminal = function (_Component) {
  ...
  _createClass(Terminal, [{
    ...
    key: "handleTextareaInteraction",
    value: function handleTextareaInteraction(e) {
      this.setState({
        cursorLocationStart: e.target.selectionStart,
        cursorLocationEnd: e.target.selectionEnd,
        currentInput: e.target.value
    ...
    value: function newCommand() {
      var currentCommand = _react2.default.createElement(_Commandline2.default, {
        text: this.state.currentInput,
        prefix: "guest@stagingsite.app:~ "
      });
      this.setState({
        commandHistory: [].concat(_toConsumableArray(this.state.commandHistory), [this.state.currentInput]),
        visibleHistory: [].concat(_toConsumableArray(this.state.visibleHistory), [currentCommand]),
        currentInput: ""
      });
    }
  }, {
    ...
    value: function render() {
      ...
      var _state = this.state,
          ...
          cursorLocationStart = _state.cursorLocationStart,
          cursorLocationEnd = _state.cursorLocationEnd,
          visibleHistory = _state.visibleHistory;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          "div",
          { className: "Terminal__intro" },
          children
        ),
        _react2.default.createElement(
          "div",
          { className: "Terminal__history" },
          visibleHistory.map(function (item, i) {
            return _react2.default.createElement(
              "div",
              { key: i },
              item
        ...
        _react2.default.createElement(
          "div",
          { className: "Terminal__current" },
          _react2.default.createElement(_Commandline2.default, {
            text: currentInput,
            active: true,
...
},{"react":"HdMw","../Commandline":"tCBH","./Terminal.css":"gYPR"}],"H99C":[function(require,module,exports) {
"use strict";
...
},{"react":"HdMw","react-dom":"X9zx","./components/Terminal":"HRuH","./index.css":"gYPR"}]},{},["H99C"], null)
//# sourceMappingURL=/src.e5319666.map